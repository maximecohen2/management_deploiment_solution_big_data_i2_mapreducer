...
public class FilmMostRentByRatingReduceClient extends Configured implements Tool {
	
	@Override
	public int run(String[] args) throws Exception {
		Job job = Job.getInstance(this.getConf(), "FilmMostRentByRating");
		
		job.setJarByClass(this.getClass()); // Quel jar pour mapReduce
		job.setMapperClass(FilmMostRentByRatingMapper.class); // Quelle class pour mapper
		job.setReducerClass(FilmMostRentByRatingReducer.class); // Quelle class pour reducer
	...
	public static void main(String[] args) throws Exception {
		System.exit(ToolRunner.run(new Configuration(), new FilmMostRentByRatingReduceClient(), args));
